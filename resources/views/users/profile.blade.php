<x-app-layout>
    <div class="grid grid-cols-4">
        ...
        <div class="px-4 col-span-2 md:ml-0 flex flex-col order-2 md:col-span-3">
            ...
            @else
                <div>
                    <a href="" class="w-30 bg-blue-400 text-white px-4 py-1 rounded text-center mt-2">
            ...
            @guest
                <div>
                    <a href="/login" class="w-30 bg-blue-400 text-whire px-3 py-1 rounded text-center mt-2">
                        {{ __('follows') }}
                    </a>
                </div>
            @endguest
        ...
        <div class="text-md mt-8 px-4 col-span-3 col-start-1 order-4 md:col-start-2 md:order-3 md:mt-0">
        ...
        <div
            class="col-span-4 my-5 py-2 border-y border-y-neutral-200 order-3 md:order-2 md:border-none md:px-4 md:col-start-2">
    ...
    @if ($user->posts->count() > 0 && (!$user->private_account || auth()->id == auth()->id))
