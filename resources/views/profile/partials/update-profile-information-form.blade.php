<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <label class="inline-flex items-center cursor-pointer">
            <input type="checkbox" name="private_account" id="private_account" class="sr-only peer"
            ...
            <span class="select-none ms-3 text-sm font-medium text-heading">{{ __('Private Account') }}</span>
        </label>
